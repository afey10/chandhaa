                ...
                <tr key={v.id} className="border-b border-[#f0f1f5] hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-1">
                      <Link to={`/vehicles/${v.id}`} className="rounded-lg p-2 text-gray-500 hover:bg-gray-100" title="View">
                        <Eye size={16} />
                      </Link>
                      {canEdit && (
                        <Link to={`/vehicles/${v.id}/edit`} className="rounded-lg p-2 text-gray-500 hover:bg-gray-100" title="Edit">
                          <Pencil size={16} />
                        </Link>
                      )}
                      {canDelete && (
